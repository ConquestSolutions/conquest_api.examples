...
// WithValue adds the value to the get action params
func (o *GetActionParams) WithValue(value int32) *GetActionParams {
	o.SetValue(value)
	return o
}

// SetValue adds the value to the get action params
func (o *GetActionParams) SetValue(value int32) {
	o.Value = value
}
