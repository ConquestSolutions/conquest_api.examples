...
/*DeleteAssetOK handles this case with default header values.
...
func (o *DeleteAssetOK) Error() string {
	return fmt.Sprintf("[POST /api/assets/delete_asset][%d] deleteAssetOK  %+v", 200, o.Payload)
}

func (o *DeleteAssetOK) GetPayload() interface{} {
	return o.Payload
}
