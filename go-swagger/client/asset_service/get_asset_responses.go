...
/*GetAssetOK handles this case with default header values.
...
func (o *GetAssetOK) Error() string {
	return fmt.Sprintf("[GET /api/assets/{value}][%d] getAssetOK  %+v", 200, o.Payload)
}

func (o *GetAssetOK) GetPayload() *models.ConquestAPIAssetEntity {
	return o.Payload
}
