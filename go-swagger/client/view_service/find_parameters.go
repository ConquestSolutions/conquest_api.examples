...
// WithBody adds the body to the find params
func (o *FindParams) WithBody(body *models.ConquestAPIFindQuery) *FindParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the find params
func (o *FindParams) SetBody(body *models.ConquestAPIFindQuery) {
	o.Body = body
}
