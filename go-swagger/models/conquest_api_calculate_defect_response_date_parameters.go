...
// ContextValidate validates this conquest api calculate defect response date parameters based on context it is used
func (m *ConquestAPICalculateDefectResponseDateParameters) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
